...
export function FolderPage() {
  ...
  const folderMissing =
    !loading && folderId !== null && (!currentFolder || currentFolder.type !== 'folder')
  ...
  return (
    <AppShell>
      ...
      >
        {dragging && !uploading && (
          <div className="pointer-events-none absolute inset-3 z-20 flex items-center justify-center rounded-xl border-2 border-dashed border-primary/50 bg-primary/5">
